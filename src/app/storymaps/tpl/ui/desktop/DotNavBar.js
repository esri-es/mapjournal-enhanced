			...
			function render(sectionIndex)
			{
                ...
                function toggleSidebar(){
                    var $sidePanel = $("#sidePanel"),
                        sidePanelWidth = parseInt($sidePanel.css("width"),10),
                        windowWidth = $(window).width();

                    window.$APP = window.$APP? window.$APP : {};
                    if(sidePanelWidth === 38){
                        var newWidth = windowWidth * window.$APP.percentage/100;
                        $sidePanel.css("width", newWidth + "px");
                        $(".header").show();
                    }else{
                        window.$APP.percentage = Math.ceil(sidePanelWidth*100/windowWidth);
                        $sidePanel.css("width", "38px");
                        $(".header").hide();
                    }
                }
